          ...
          <div class="col-12 col-md-12 col-lg-5">
            <div class="card profile-widget">
              <div class="profile-widget-header">
                <img alt="image" src="{{ asset('adminAsset/assets/img/avatar/avatar-1.png') }}" class="rounded-circle profile-widget-picture">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-5 col-12">
                        <label>Phone</label>
                        <input type="tel" class="form-control" value="{{ $user->id }}">
                      </div>
                    </div>
                    <div class="row">
